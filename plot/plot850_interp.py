...
plt.ioff()  
outputdata = '../output_0511/'
outputdata = '../output_2020051100_zonal_mean/'
outputdata = '/wk2/yungyun/FCNV2_TC/202405W/FCNV2_forecast/2024071800/'
outputdata = '/wk2/yungyun/code_space/FCNV2_test/FCNV2_introplation_test/test_interpolation/'
outputdata = '/wk2/yungyun/code_space/FCNV2_test/FCNV2_introplation_test/test_interpolation_new/'
outputdata = '/wk2/yungyun/code_space/FCNV2_test/FCNV2_introplation_test/test_interpolation_IFS/'
# save_figure = 'plot_interp_test/'
save_figure = 'plot_interp_test_IFS/'
if not os.path.isdir(save_figure):
...
files = 0
file_list = os.listdir(outputdata)
...
for i in range(0,files):
    print(i)
    # data = np.load(f'{outputdata}output_weather_{(i)*6}h.npy')
    data = np.load(f'{outputdata}output_weather_{i:0>3}h.npy')
    ...
    plt.savefig(f'{save_figure}new_predict_{i:0>3}h.png',dpi=200)
    plt.close()
